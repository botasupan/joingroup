...
async def not_joined(client: Client, message: Message):
    text = "<b>Anda harus JOIN GROUP terlebih dahulu untuk menggunakan BOT ini.\n\nKalau belum JOIN, BOT tidak akan menampilkan Video. Jika sudah JOIN GROUP, silahkan kembali ke bot ini dan klik GET FILE</b>"
    ...
    reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🔞 JOIN GROUP HERE 🔞", url = client.invitelink),
                ],[
